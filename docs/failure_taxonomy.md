...
| `context_truncation` | Relevant candidate evidence is not selected into context. | Heuristic | A relevant retrieved or reranked document exists, but no selected context chunk references it. |
